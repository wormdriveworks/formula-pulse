...
- **Godot 버전은 4.7 계열 고정** (D12 §1.1 확정 핀 — v1.1 결정 #11·현행 v1.3 — 정본 정합). 다르면 `.tscn`/기능 차이로 디프가 오염된다. 설치 실물 = 4.7.1-stable.
...
- **단일 진실 원천:** `docs/master_plan_v2_60.md`
