...
| `docs/master_plan_v2_31.md` | 단일 진실 원천 (문서 판번·운영 규칙) |
...
마일스톤: ~~MS-1 프로토타입~~ → ~~**MS-2 버티컬 슬라이스** (완료 2026-08-15)~~ → **MS-3 Steam EA (현 단계)** → MS-4 Steam 1.0 → MS-5 모바일 소프트 런칭 → MS-6 모바일 글로벌 (D15 §1.1 — 직렬).
