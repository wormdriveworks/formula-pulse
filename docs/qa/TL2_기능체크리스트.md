...
> 생성 규칙 정본: D14 §2.2 · 화면 목록 정본: D09 별첨A v1.3 · 범위: IMPL-077 (25종 − SYS-04·TUT-01)
...
- [ ] ①진입/이탈 — 진입: SYS-01 / 이탈: SYS-01·HUB-05·NAR-01 (실측 — 별첨A 플로우와 대조)
...
- [ ] ③옵션 반영 — 소비 실측: (직접 소비 없음 — 공통 채널 경유 여부 확인)
- [ ] ④T-1 완칭 — 사용 키 29종 · '티어' 단독 표기 기계 검사 통과 (문면 눈 대조는 실행 시)
- [x] ⑤금지 구역 진입점 0 — 광고 계층 어휘 0건 (기계 판정 통과)
...
- [ ] ①진입/이탈 — 진입: HUB-01 / 이탈: SYS-01·RACE-03 (실측 — 별첨A 플로우와 대조)
- [ ] ②표시 요소 전수 (41개 실측): E01Position(Label)·E02LapSector(Label)·E02SectorAttr(TextureRect)·E02Corner(Label)·E02Resonance(Label)·FrontLabel(Label)·E03FrontGauge(ProgressBar)·RearLabel(Label)·E03RearGauge(ProgressBar)·E05SnapshotNew(Button)·Symbol(TextureRect)·Symbol(TextureRect)·Symbol(TextureRect)·E05Snapshot(Button)·Sym0(TextureRect)·Sym1(TextureRect)·Sym2(TextureRect)·E07VaneText(Label)·E08Respin(Button)·E08ChargeIntervene(Button)·E08Confirm(Button)·RejectNotice(Label)·Sc3Left(Button)·Sc3Right(Button)·E04TimerValue(Label)·ChassisLabel(Label)·E11ChassisBar(ProgressBar)·E11ChassisValue(Label)·ChargeLabel(Label)·E12Charge(Label)·Slot1(Button)·Slot2(Button)·Skill1(Button)·Skill2(Button)·Skill3(Button)·Skill4(Button)·Skill5(Button)·E14Menu(Button)·StepLabel(Label)·SkipButton(Button)·CalloutText(Label)
- [ ] ③옵션 반영 — 소비 실측: param_fx_duel_result_hold_sec·O4·param_opt_reel_fast_mult·O5·param_opt_timer_mult_1·param_opt_timer_mult_2·O6·param_fx_shake_weak_px·param_fx_shake_strong_px·param_fx_reduced_mult·O12·param_fx_gauge_pulse_sec·param_fx_shake_sec·param_fx_flash_alpha·param_fx_flash_sec
- [ ] ④T-1 완칭 — 사용 키 115종 · '티어' 단독 표기 기계 검사 통과 (문면 눈 대조는 실행 시)
- [x] ⑤금지 구역 진입점 0 — 광고 계층 어휘 0건 (기계 판정 통과)

## RACE-02 듀얼 오버레이 (§A-7)
- 구현: res://ui/race/duel_overlay.gd
- [ ] ①진입/이탈 — 진입: RACE-01 듀얼 삽입 (D05 §3 상태 머신 1:1 — 라우터 비경유) / 이탈: 듀얼 결판 → RACE-01 복귀 (결과 프레임 내 표기 후 해제)
- [ ] ②표시 요소 전수 (6개 실측): PlayerLabel(Label)·KindLabel(Label)·OpponentLabel(Label)·BoostStack(Label)·BoostButton(Button)·ResultLabel(Label)
- [ ] ③옵션 반영 — 소비 실측: (직접 소비 없음 — 공통 채널 경유 여부 확인)
...
- [ ] ①진입/이탈 — 진입: RACE-01 / 이탈: SET-01·RUN-02·HUB-01 (실측 — 별첨A 플로우와 대조)
...
- [ ] ③옵션 반영 — 소비 실측: (직접 소비 없음 — 공통 채널 경유 여부 확인)
- [ ] ④T-1 완칭 — 사용 키 24종 · '티어' 단독 표기 기계 검사 통과 (문면 눈 대조는 실행 시)
- [x] ⑤금지 구역 진입점 0 — 광고 계층 어휘 0건 (기계 판정 통과)
...
- [ ] ①진입/이탈 — 진입: RACE-03 / 이탈: HUB-01 (실측 — 별첨A 플로우와 대조)
- [ ] ②표시 요소 전수 (7개 실측): TitleLabel(Label)·VariantLabel(Label)·BodyLabel(Label)·RewardIcon(TextureRect)·RewardValue(Label)·RareBadge(Label)·ProceedButton(Button)
- [ ] ③옵션 반영 — 소비 실측: (직접 소비 없음 — 공통 채널 경유 여부 확인)
...
- [ ] ②표시 요소 전수 (15개 실측): CreditIcon(TextureRect)·CreditValue(Label)·DataIcon(TextureRect)·DataValue(Label)·ProgressLabel(Label)·BackButton(Button)·HeaderLabel(Label)·CardLabel(Label)·CostLabel(Label)·TotalCostValue(Label)·AffordableValue(Label)·ChassisValue(Label)·FreeLineNote(Label)·RunButton(Button)·ConsumableTitle(Label)
- [ ] ③옵션 반영 — 소비 실측: (직접 소비 없음 — 공통 채널 경유 여부 확인)
- [ ] ④T-1 완칭 — 사용 키 12종 · '티어' 단독 표기 기계 검사 통과 (문면 눈 대조는 실행 시)
- [x] ⑤금지 구역 진입점 0 — 광고 계층 어휘 0건 (기계 판정 통과)
...
- [ ] ③옵션 반영 — 소비 실측: (직접 소비 없음 — 공통 채널 경유 여부 확인)
- [ ] ④T-1 완칭 — 사용 키 15종 · '티어' 단독 표기 기계 검사 통과 (문면 눈 대조는 실행 시)
- [x] ⑤금지 구역 진입점 0 — 광고 계층 어휘 0건 (기계 판정 통과)
...
- [ ] ①진입/이탈 — 진입: SYS-02 / 이탈: NAR-01·HUB-01 (실측 — 별첨A 플로우와 대조)
...
- [ ] ③옵션 반영 — 소비 실측: (직접 소비 없음 — 공통 채널 경유 여부 확인)
- [ ] ④T-1 완칭 — 사용 키 37종 · '티어' 단독 표기 기계 검사 통과 (문면 눈 대조는 실행 시)
- [x] ⑤금지 구역 진입점 0 — 광고 계층 어휘 0건 (기계 판정 통과)

## HUB-06 스폰서 데스크 (§A-16)
- 구현: res://ui/hub/sponsor_desk_screen.gd
- [ ] ①진입/이탈 — 진입: (역참조 없음 — 세션 전이 확인) / 이탈: HUB-01 (실측 — 별첨A 플로우와 대조)
- [ ] ②표시 요소 전수 (9개 실측): CreditIcon(TextureRect)·CreditValue(Label)·DataIcon(TextureRect)·DataValue(Label)·ProgressLabel(Label)·BackButton(Button)·HeaderLabel(Label)·SlotLabel(Label)·WindowNote(Label)
- [ ] ③옵션 반영 — 소비 실측: (직접 소비 없음 — 공통 채널 경유 여부 확인)
- [ ] ④T-1 완칭 — 사용 키 19종 · '티어' 단독 표기 기계 검사 통과 (문면 눈 대조는 실행 시)
- [x] ⑤금지 구역 진입점 0 — 광고 계층 어휘 0건 (기계 판정 통과)
...
- [ ] ①진입/이탈 — 진입: SET-02 / 이탈: NAR-01·HUB-01 (실측 — 별첨A 플로우와 대조)
- [ ] ②표시 요소 전수 (10개 실측): CreditIcon(TextureRect)·CreditValue(Label)·DataIcon(TextureRect)·DataValue(Label)·ProgressLabel(Label)·BackButton(Button)·HeaderLabel(Label)·GradeLabel(Label)·ConfirmButton(Button)·SkipButton(Button)
- [ ] ③옵션 반영 — 소비 실측: (직접 소비 없음 — 공통 채널 경유 여부 확인)
- [ ] ④T-1 완칭 — 사용 키 17종 · '티어' 단독 표기 기계 검사 통과 (문면 눈 대조는 실행 시)
- [x] ⑤금지 구역 진입점 0 — 광고 계층 어휘 0건 (기계 판정 통과)

## NAR-01 VN 이벤트 화면 (§A-19)
- 구현: res://ui/nar/vn_screen.gd
- [ ] ①진입/이탈 — 진입: SYS-02·SET-01·HUB-01·HUB-05·HUB-08 / 이탈: (go 호출 없음 — 전이 주체 확인) (실측 — 별첨A 플로우와 대조)
...
- [ ] ①진입/이탈 — 진입: RACE-03 / 이탈: NAR-01 (실측 — 별첨A 플로우와 대조)
- [ ] ②표시 요소 전수 (20개 실측): HeaderLabel(Label)·DropoutBadge(Label)·SaveBadge(Label)·SubHeaderLabel(Label)·Block1Label(Label)·Block1Value(Label)·Block2Label(Label)·Block2Value(Label)·Block3Label(Label)·Block3Value(Label)·Block3Note(Label)·SponsorLabel(Label)·SponsorValue(Label)·Block4Label(Label)·Block4Value(Label)·Block5Label(Label)·Block5Value(Label)·Block6Label(Label)·Block6Value(Label)·NextButton(Button)
- [ ] ③옵션 반영 — 소비 실측: (직접 소비 없음 — 공통 채널 경유 여부 확인)
- [ ] ④T-1 완칭 — 사용 키 21종 · '티어' 단독 표기 기계 검사 통과 (문면 눈 대조는 실행 시)
- [x] ⑤금지 구역 진입점 0 — 광고 계층 어휘 0건 (기계 판정 통과)

## SET-02 시즌 결산 화면 (§A-22)
- 구현: res://ui/settle/season_result_screen.gd
- [ ] ①진입/이탈 — 진입: (역참조 없음 — 세션 전이 확인) / 이탈: HUB-08 (실측 — 별첨A 플로우와 대조)
- [ ] ②표시 요소 전수 (12개 실측): HeaderLabel(Label)·VerdictLabel(Label)·EpilogueLabel(Label)·RankLabel(Label)·RankValue(Label)·PointsLabel(Label)·PointsValue(Label)·TourWinsLabel(Label)·TourWinsValue(Label)·GridLabel(Label)·GridValue(Label)·NextButton(Button)
- [ ] ③옵션 반영 — 소비 실측: (직접 소비 없음 — 공통 채널 경유 여부 확인)
- [ ] ④T-1 완칭 — 사용 키 15종 · '티어' 단독 표기 기계 검사 통과 (문면 눈 대조는 실행 시)
- [x] ⑤금지 구역 진입점 0 — 광고 계층 어휘 0건 (기계 판정 통과)
