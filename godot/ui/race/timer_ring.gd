...
# [가안] 두께·점멸 주기: D09 §3.2는 순서 관계('가는/중간/굵은' · '저속/고속 점멸')만 확정하고
# 실수치를 주지 않으며 D13 대장에도 없다. 640×360 도트 원도 기준으로 1·2·3px를 배정해
# ×3 표시에서 3·6·9px가 되게 했다(정수 배율 유지 — D12 §9.1). — IMPL-071
